...
const businessSchema = new mongoose.Schema({
        ...
        business_timing: { type: Object, required: true, trim: true },
        business_address: { type: String, required: true, trim: true },
        business_locality: { type: String, required: true, trim: true },
        business_city: { type: String, required: true, trim: true },
        business_state: { type: String, required: true, trim: true },
        business_pin: { type: Number, required: true, trim: true },
